...
const directory = resolve("approved-materials","index","bailii-case-law");
...
for (const filename of metadataFiles) {
  ...
  const result = await indexDocument("__public__",{
    ...
    metadata:{ reviewer:metadata.reviewer,approvalStatus:metadata.approval_status,sourceType:metadata.source_type,
      ...
      court:metadata.court,seminars:metadata.seminars,topics:metadata.topics,licenceUrl:metadata.licence_url,
      statusNote:metadata.status_note,originalHtml:metadata.files.html.path,updateCycleDays:180 }
  });
