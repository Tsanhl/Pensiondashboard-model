#!/usr/bin/env python3
"""Exact tokenizer and prompt-loss-mask preflight for the 94-record review candidate.
...
ROOT = Path(
    sys.argv[1]
    if len(sys.argv) > 1
    else "training/evaluation-cycle-v2/24-cumulative-visible-qualification-v8-final-compact-20260901"
).resolve()
...
CONFIG_PATH = (WORKSPACE / "training/cumulative_visible_mlx_config_v1.yaml").resolve()
MANIFEST_PATH = (
...
global_checks = {
    ...
    "exact_94_unique_rows": len(ids) == 94 and len(set(ids)) == 94,
