...
const directory = resolve("approved-materials","index","eu-legislation");
...
for (const filename of metadataFiles) {
  ...
  const result = await indexDocument("__public__",{
    ...
    metadata:{ reviewer:metadata.reviewer,approvalStatus:metadata.approval_status,sourceType:metadata.source_type,
      ...
      celex:metadata.celex,seminars:metadata.seminars,topics:metadata.topics,licenceUrl:metadata.licence_url,
      statusNote:metadata.status_note,originalPdf:metadata.files.pdf.path,updateCycleDays:30 }
  });
